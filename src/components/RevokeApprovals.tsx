          ...
          {!isConnected ? (
            <div className="text-center py-12">
              ...
              <p className="text-sm text-cyber-neon/60 mt-4">
                Use the <span className="text-cyber-neon font-semibold">ACCESS_WALLET</span> button in the header to connect
              </p>
              <p className="text-sm text-cyber-neon/60 mt-4">
            ...
            <div className="text-center py-12">
              ...
              <Button 
                ...
                className="mt-4 bg-green-800 text-cyber-neon hover:bg-green-700 font-mono"
              >
                Refresh Approvals
              </Button>
            </div>
            ...
            <>
              <div className="mb-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button 
                    onClick={fetchApprovals} 
                    className="bg-green-800 text-cyber-neon hover:bg-green-700 font-mono text-xs"
                    size="sm"
                  >
                    Refresh
                  </Button>
                ...
                <Table>
                  ...
                  <TableBody>
                    {approvals.map((approval) => {
                      ...
                      return (
                        <TableRow key={approvalId} className="border-b border-cyber-neon/10">
                          ...
                          <TableCell className="text-right">
                            <div className="flex justify-end gap-2">
                              <Button
                                ...
                                onClick={() => window.open(`https://etherscan.io/token/${approval.tokenAddress}`, '_blank')}
                              >
